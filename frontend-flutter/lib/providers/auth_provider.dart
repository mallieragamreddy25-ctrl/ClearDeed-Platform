...
/// Auth provider - manages auth state using StateNotifier
final authProvider =
...
/// Auth token provider - access just the token
final authTokenProvider = Provider<String?>((ref) {
  return ref.watch(authProvider).token;
});

/// Is authenticated provider - easily check if user is logged in
final isAuthenticatedProvider = Provider<bool>((ref) {
  return ref.watch(authProvider).isAuthenticated;
});

/// Is loading provider - check if auth operation is in progress
final isAuthLoadingProvider = Provider<bool>((ref) {
  return ref.watch(authProvider).isLoading;
});

/// Auth error provider - access auth error message
